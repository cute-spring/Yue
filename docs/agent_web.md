...
*   **实现细节**：[web.py](file:///Users/gavinzhang/ws-ai-recharge-2026/claw2026/nanobot/nanobot/agent/tools/web.py)
*   **优点**：
    *   **低延迟**：无浏览器启动开销，毫秒级响应。
...
- [builtin/registry.py](file:///Users/gavinzhang/ws-ai-recharge-2026/Yue/backend/app/mcp/builtin/registry.py)
- [builtin/docs.py](file:///Users/gavinzhang/ws-ai-recharge-2026/Yue/backend/app/mcp/builtin/docs.py)
...
*   **最佳实践**：使用 `readability` 提取 Summary 后，通过正则或专用库转为 Markdown。[web.py:L146-L149](file:///Users/gavinzhang/ws-ai-recharge-2026/claw2026/nanobot/nanobot/agent/tools/web.py#L146-L149) 展示了这种极简但高效的过滤逻辑。

### **3.2 安全栅栏 (Guardrails)**
*   **URL 校验**：严格限制协议（只允许 http/https），防止 SSRF。
*   **长度截断**：设置 `max_chars`。大模型的上下文窗口是昂贵的，永远不要让 Agent 无节制地“吞掉”10MB 的 HTML 内容。[web.py:L153-L158](file:///Users/gavinzhang/ws-ai-recharge-2026/claw2026/nanobot/nanobot/agent/tools/web.py#L153-L158)
