...
export const buildPreferencesFromFormData = (
  ...
  return {
    ...
    capture_suggestions_enabled: formData.get('capture_suggestions_enabled') !== null,
    memory_suggestions_enabled: formData.get('memory_suggestions_enabled') !== null,
    note_recall_enabled: formData.get('note_recall_enabled') !== null,
