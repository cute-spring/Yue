# 12 - Run Agent Instruction Review on one skill or agent

**What to build:** An admin can review one selected skill or agent and receive a report covering triggers, context load, tools, safety, examples, and Yue runtime fit.
